...
SOURCEFILES_QUOTED_IF_SPACED=../src/Common/uart2.c ../src/USB/usb_device.c ../src/USB/usb_function_cdc.c ../src/Nokia_5110_Example.c ../src/Sound.c ../src/badge14.c ../src/badge_common.c ../src/main.c ../src/time_date.c ../src/usb_descriptors.c ../src/touch.S ../src/timer1_int.c
...
# Source Files
SOURCEFILES=../src/Common/uart2.c ../src/USB/usb_device.c ../src/USB/usb_function_cdc.c ../src/Nokia_5110_Example.c ../src/Sound.c ../src/badge14.c ../src/badge_common.c ../src/main.c ../src/time_date.c ../src/usb_descriptors.c ../src/touch.S ../src/timer1_int.c
...
${OBJECTDIR}/_ext/1360937237/main.o: ../src/main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/1360937237/main.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -O1 -fschedule-insns -DPIC32MX460F512L_PIM -DGLCD_DEVICE_PIC24H -DGLCD_CONTROLLER_PCD8544 -DGLCD_USE_SPI -I"../src" -MMD -MF "${OBJECTDIR}/_ext/1360937237/main.o.d" -o ${OBJECTDIR}/_ext/1360937237/main.o ../src/main.c    -G0
...
dist/${CND_CONF}/${IMAGE_TYPE}/Badge14.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../src/app_32MX250F128D.ld
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION) -O1 -mno-float -o dist/${CND_CONF}/${IMAGE_TYPE}/Badge14.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}           -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC00490:0x1FC00BEF -mreserve=boot@0x1FC00490:0x1FC00BEF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,--defsym=_min_heap_size=256,--defsym=_min_stack_size=2048,-Map="mappit",--cref,-G0
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Badge14.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   ../src/app_32MX250F128D.ld
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION) -O1 -mno-float -o dist/${CND_CONF}/${IMAGE_TYPE}/Badge14.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=_min_heap_size=256,--defsym=_min_stack_size=2048,-Map="mappit",--cref,-G0
